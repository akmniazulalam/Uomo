...
const Banner = () => {
  ...
  return (
    <div className="w-fit border-2 border-bgColor p-2 m-auto relative">
      <div
        className={
          "w-[93vw] bg-[url('/src/assets/bg.png')] bg-no-repeat bg-center bg-cover "
        }>
        <Container>
          <Slider {...settings}>
            <div className="pt-[273px] pb-[283px] relative">
              ...
              <div className="relative">
                <p className="uppercase font-bold text-[120px] text-transparent rotate-90 summer absolute bottom-[0%] left-[72%] w-[550px]">
                  {
                    <>
